...
// render both an absolute texture and a stateful particle generator, so coverage scans see
// material transport at the same 2,300-pixel / eight-member workload. This is a compositor
