/** Frozen pre-workstream-2 renderer for parity + matched benchmark ONLY. Not registered.
 * Source: efbf269230ba23c77e1adbc243b059c0b59835e4:packages/core/src/effects/impl/spatial-field.ts
 * Original SHA-256: b0d1355490e7b2037ecd47c00d0c4654adb4fda2b24973e4fcd3a87b3535e13f
 * Only relative imports and exported names differ below. Do not sync to production changes.
 */
...
export interface SpatialFieldReferenceState {
  em: EmitterState;
}
 ...
 */
export const spatialFieldReference: EffectGenerator<SpatialFieldReferenceState> = {
  id: 'spatial-field',
  name: 'Spatial Field',
  category: 'texture',
  timebase: 'absolute',
  ...
  createState(): SpatialFieldReferenceState {
