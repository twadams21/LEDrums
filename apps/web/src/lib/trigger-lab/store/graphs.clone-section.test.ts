...
describe('cloneSectionGraphs', () => {
  it('deep-copies each source key once and sanitizes forbidden duplicate placements', () => {
    ...
    expect(out.section).toMatchObject({ id: 's', name: 'Verse', graphs: ['copy-1', 'copy-2'], looks: { base: null } });
