...
| R21 store split 2/5 | #100 | wt-1 | gen3r/r21-store-midi | r21-midi-aac79c | running (MIDI input/learn controller; follows R20's pattern) |
...
| R11b DnD polish | — | wt-3 | gen3r/r11b-sections-dnd-polish | r11b-polish-186e5a | running — Trent screenshot feedback: (1) kill blue wash on section while dragging, (2) fix broken drag-ghost/double-row visuals on graph drag, (3) section reorder gets a VERTICAL insert-line between columns instead of target highlight |
...
| P1 review (R01–R08) | — | wt-2 | gen3r/p1-review-report | p1-review-64e737 | running (opus/high; one-validator invariant, undo shapes, lint-trio consistency, cache interaction) |
