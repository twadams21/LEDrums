# Adversarial Review Rubric — v2

**Target:** `docs/plans/2026-07-26-deep-review/SPEC.md` (revised — v2)
**Prior round:** v1 drew REVISE (7 findings) and BLOCK (8 findings). Adjudication in
`REVIEW-RESPONSE.md`. 11 findings accepted, 2 rejected, 1 narrowed.
